        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4 padding0">
                <div class="plan text-center">
                    <header>
                        <h2><?php esc_html_e('Features', 'quality'); ?></h2>
                    </header>
            ...
            <div class="col-md-4 padding0">
                <div class="plan text-center">
                    ...
                    <header>
                        <h2><?php esc_html_e('Quality', 'quality'); ?></h2>
                    </header>

                    <ul class="feature">
                        <li style="font-size:16px; line-height:25px; padding:28px"> 

                            <?php esc_html_e("A Slider with 1 static image, 3 Services, 4 Portfolios, Latest News", "quality"); ?>


                        </li>
                        <li style="font-size:16px; line-height:25px; padding:28px"> 
                            <?php esc_html_e("Business Template and Full-Width Template", "quality"); ?>
                        </li><li style="font-size:16px; line-height:25px; padding:43px"><?php esc_html_e("Full-Width Layout", "quality"); ?> </li>
                        ...
                        <li><span class="dashicons-before dashicons-no-alt red"></span></li>
                        <li><span class="dashicons-before dashicons-no-alt red"></span></li>
                        <li style="font-size:16px; line-height:80px; padding:15px;"><a href="<?php echo esc_url('https://wordpress.org/support/theme/quality'); ?>" target="_blank" ><?php esc_html_e("On the WordPress.org support forum", "quality"); ?></a></li>
            ...
            <div class="col-md-4 padding0">
                <div class="plan text-center border-right">
                    ...
                    <header>
                        <h2><?php esc_html_e('Quality PRO', 'quality'); ?></h2>
                    </header>

                    <ul class="feature">
                        <li style="font-size:16px; line-height:25px; padding:19px">
                            <?php esc_html_e("A top header, unlimited sliders, unlimited services, unlimited portfolios, latest news, clients, testimonials, custom widgets", "quality"); ?>
                        </li>
                        <li style="font-size:16px; line-height:25px; padding:18px"><?php esc_html_e("About Us, Services, Portfolios, Blogs with left and right sidebars or full-width, full-width pages, Contact forms and much more.", "quality"); ?></li>
                        <li style="font-size:16px; line-height:25px; padding:43px"><?php esc_html_e("Full-Width layout & Boxed layout", "quality"); ?></li>
                        <li><span class="dashicons-before dashicons-yes green"></span></li>
                        <li><span class="dashicons-before dashicons-yes green"></span></li>
                        <li><span class="dashicons-before dashicons-yes green"></span></li>
                        <li><span class="dashicons-before dashicons-yes green"></span></li>
                        ...
                        <li><span class="dashicons-before dashicons-yes green"></span></li>
                        <li><span class="dashicons-before dashicons-yes green"></span></li>
                        <li style="font-size:16px; line-height:80px; padding:15px;"><a href="<?php echo esc_url('http://webriti.com/support/categories/quality'); ?>" target="_blank"><?php esc_html_e("PRO Support Forum", "quality"); ?></a></li>
