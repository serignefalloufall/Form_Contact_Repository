...
if (!function_exists('webriti_companion') && !$quality_hide_install) {
	if (class_exists('WP_Customize_Section') && !class_exists('Quality_Companion_Installer_Section')) {
		 ...
		 */
		class Quality_Companion_Installer_Section extends WP_Customize_Section {
			/**
			 ...
			 * @var string
			 */
			public $type = 'quality_companion_installer';

			public function __construct($manager, $id, $args = array()) {
				parent::__construct($manager, $id, $args);

				add_action('customize_controls_enqueue_scripts', 'Quality_Companion_Installer_Section::enqueue');
			}
...
function quality_hide_customizer_companion_notice(){
	update_option('quality_hide_customizer_companion_notice', true);
	echo true;
	wp_die();
}
add_action('wp_ajax_quality_hide_customizer_companion_notice', 'quality_hide_customizer_companion_notice');